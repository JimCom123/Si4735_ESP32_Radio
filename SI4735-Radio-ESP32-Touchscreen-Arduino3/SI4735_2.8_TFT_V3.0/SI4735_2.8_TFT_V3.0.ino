...
Band band[] = {  ////
  ...
  {   "LW", LW_BAND_TYPE,  AM,   100,   513,   164, 3}, //  LW          1  ////
  {   "MW", MW_BAND_TYPE,  AM,   522,  1701,   666, 9}, //  MW          2  ////
  {"2220M", LW_BAND_TYPE, LSB,   135,   138,   137, 5}, // Ham          3  ////
  { "630M", SW_BAND_TYPE, LSB,   472,   479,   475, 5}, // Ham  630M    4
  { "160M", SW_BAND_TYPE, LSB,  1800,  1913,  1910, 5}, // Ham  160M    5  ////
  { "120M", SW_BAND_TYPE,  AM,  2300,  2850,  2850, 5}, //      120M    6
  {  "90M", SW_BAND_TYPE,  AM,  3200,  3400,  3320, 5}, //       90M    7  ////
  ...
  {  "40M", SW_BAND_TYPE, LSB,  7000,  7300,  7100, 5}, // Ham   40M   12  ////
  {  "41M", SW_BAND_TYPE,  AM,  7200,  7450,  7250, 5}, //       41M   13  ////
  {  "31M", SW_BAND_TYPE,  AM,  9400,  9900,  9650, 5}, //       31M   14  ////
  {  "30M", SW_BAND_TYPE, USB, 10100, 10150, 10120, 5}, // Ham   30M   15
  {  "25M", SW_BAND_TYPE,  AM, 11600, 12100, 11685, 5}, //       25M   16  ////
  ...
  {  "17M", SW_BAND_TYPE, USB, 18068, 18168, 18100, 5}, // Ham   17M   20
  ...
  {   "CB", SW_BAND_TYPE,  AM, 26200, 27990, 26965, 1}, // CB band     27  ////
...
////  delay(500);
  ...
  Serial.println("Version 3.0j 08-16-2020");
  tft.println("SI4735  Radio");
  tft.setCursor(7, 70);
  tft.println(" Version 3.0-JimCom");
  tft.setCursor(7, 95);
  tft.println(" 08-30-2020");
  tft.setCursor(7, 130);
////  delay(1000);
...
//////  si4735.setI2CFastModeCustom(1000000); // It is a test and may crash. ////
            ...
            if (n == 11) {// Send button
              ...
              if(Displayfreq < 1) {
                ...
                ErrorBeep();
                 ...
                 if ((Displayfreq > 30) and (Displayfreq < 76 )) {   ////
                  tft.setCursor(7, 25);
                  tft.print("Freqency > 30MHz and < 76 MHz");   ////
                  ErrorBeep();
                }else{
                  if ((Displayfreq >= 108) and (Displayfreq < 153 )) {
                    ...
                    if ((Displayfreq >= 76) and (Displayfreq <= 108)) {   ////
